...
qemu-img resize jammy-server-cloudimg-amd64.img 12G
...
qm set 9000 --scsi0 poolcluster:0,import-from=/root/jammy-server-cloudimg-amd64.img
#qm disk import 9000 jammy-server-cloudimg-amd64.img local-lvm
#qm set 9000 --scsihw virtio-scsi-pci --scsi0 local-lvm:vm-9000-disk-0
qm set 9000 --boot c --bootdisk scsi0
qm set 9000 --ide2 poolcluster:cloudinit
